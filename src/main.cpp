...
// ----------------- 판정 임계값 -----------------
const float RATIO_MIN = 1.25f;
const float RATIO_MAX = 1.38f;

const int R_MIN = 76; // R 하한
const int R_MAX = 82; // R 상한

const int G_MIN = 91; // G 하한
const int G_MAX = 92; // G 상한

const int B_MIN = 58; // B 하한
const int B_MAX = 62; // B 상한
// ------------------------------------------------
