...
// ----------------- 판정 임계값 -----------------
const float RATIO_MIN = 1.09f;
const float RATIO_MAX = 1.30f;

const int R_MIN = 102; // R 하한
const int R_MAX = 115; // R 상한

const int G_MIN = 84; // G 하한
const int G_MAX = 95; // G 상한

const int B_MIN = 38; // B 하한
const int B_MAX = 52; // B 상한
// ------------------------------------------------
